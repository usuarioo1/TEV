...
export async function exportHallazgoPdf(nc: Hallazgo) {
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <Text style={styles.title}>Hallazgo #{nc.id}</Text>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Detalle del hallazgo</Text>
    ...
    anchor.href = url;
    anchor.download = `hallazgo-${nc.id}.pdf`;
    anchor.click();
