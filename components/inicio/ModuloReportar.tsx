...
type TipoFormulario = 'peligro' | 'stop' | 'art';

interface ModuloReportarProps {
    rol: string;
...
export default function ModuloReportar({ rol, onOpenModal }: ModuloReportarProps) {
    return (
        <div className="mb-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                {/* Caminatas de Seguridad - solo para no coordinadores */}
                {rol !== 'coordinador' && (
                    <Link
                ...
                {/* Controles de Calidad ART - solo para no coordinadores */}
                {rol !== 'coordinador' && (
                    <button
