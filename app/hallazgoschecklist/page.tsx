...
export default function HallazgosChecklistPage() {
    const { session, loading } = useSession();
    const router = useRouter();
    const resyncPendienteRef = useRef(true);
    ...
    const fetchHallazgos = useCallback(async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setHallazgos(data);
                resyncPendienteRef.current = false;
            }
        } finally {
            setFetching(false);
        }
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-900">Hallazgos Checklist</h1>
                    <p className="text-gray-500 mt-1">
                        Items con respuesta &quot;SI&quot; e información adicional detectados en checklists de tractocamión y semirremolque
                    </p>
                </div>
